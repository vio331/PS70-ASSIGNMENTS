...
#define DFPLAYER_RX 6  // GPIO6 (D6) - Connect to TX pin on DFPlayer
#define DFPLAYER_TX 7  // GPIO7 (D7) - Connect to RX pin on DFPlayer
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (currentLine.endsWith("GET /fart")) {
          ...
          myDFPlayer.play(1);  // Play file 0001.mp3 from the SD card
        }
      }
    }
